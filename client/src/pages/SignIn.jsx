...
const SignIn = () => {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100vh', backgroundColor: 'var(--primary-background)', padding: '20px', textAlign: 'center' }}>
      <div style={{ border: '1px solid #000000', borderRadius: '10px', padding: '30px', width: '100%', maxWidth: '520px', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        <h1 style={{ color: 'var(--primary)', fontSize: '2.5rem', marginBottom: '0' }}>Sign In</h1>
        <p style={{ color: '#666', marginBottom: '5px' }}>Welcome Back !</p>

        {error && <div style={{ color: 'red', marginBottom: '1rem', textAlign: 'center', fontSize: '0.9rem', backgroundColor: '#ffebee', padding: '10px', borderRadius: '5px', width: '100%', maxWidth: '300px' }}>{error}</div>}
        ...
        <div style={{ width: '100%', maxWidth: '300px', marginBottom: '1rem' }}>
          <input
            style={{ width: '100%', padding: '10px', border: fieldErrors.email ? '1px solid red' : '1px solid #ccc', borderRadius: '25px', fontFamily: 'var(--manrope)', textAlign: 'left' }}
            type="email"
            name="email"
        ...
        <div style={{ width: '100%', maxWidth: '300px', marginBottom: '1rem' }}>
          <input
            style={{ width: '100%', padding: '10px', border: fieldErrors.password ? '1px solid red' : '1px solid #ccc', borderRadius: '25px', fontFamily: 'var(--manrope)', textAlign: 'left' }}
            type="password"
            name="password"
        ...
        <div style={{ width: '100%', maxWidth: '300px', textAlign: 'right', marginBottom: '1rem' }}>
          <span style={{ color: 'var(--primary)', fontSize: '0.9rem', cursor: 'pointer', textDecoration: 'underline' }} onClick={() => alert('Forgot password feature coming soon!')}>Forgot Password?</span>
        </div>
        ...
        <p style={{ marginTop: '1rem', color: '#666', textAlign: 'center' }}>
          Not a user?{' '}
          <span style={{ color: 'var(--primary)', textDecoration: 'underline', cursor: 'pointer' }} onClick={handleSignupClick}>Signup</span>
        </p>
      </div>
    </div>
  );
